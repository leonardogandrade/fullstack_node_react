...
const musculacaoController = require('./controllers/musculacao.js');
...
//Capturando os paramâmetros da requisição pela URL usando params
routes.post('/prog/:nome', (req,res)=>{
    const response = req.params.nome;
    res.send(response);
});

//Capturando os paramâmetros da requisição pela URL usando query
